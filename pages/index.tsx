      ...
      <div className="bg-white flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {[1, 2].map((i) => (
            <div
              key={i}
              className="flex justify-between mt-2 pt-2 odd:bg-blue-50 even:bg-yellow-50"
            >
      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          ...
          <div className="relative mt-5 flex flex-col items-center -mt-10 -mb-5">
            <span className="text-lg font-medium">Hyungyu Noh</span>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              <button
                className="w-5 h-5 rounded-full bg-yellow-500 transition
              focus:ring-2 ring-offset-2 ring-yellow-500"
              />
              <button
                className="w-5 h-5 rounded-full bg-indigo-500 transition
              focus:ring-2 ring-offset-2 ring-indigo-500"
              />
              <button
                className="w-5 h-5 rounded-full bg-teal-500 transition
              focus:ring-2 ring-offset-2 ring-teal-500"
              />
            </div>
            <div className="flex items-center space-x-5">
              <button className="rounded-lg bg-blue-200 flex justify-center itmes-center aspect-square w-8 text-xl text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="rounded-lg bg-blue-200 flex justify-center itmes-center aspect-square w-8 text-xl text-gray-500">
