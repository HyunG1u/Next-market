...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      <span className="inline-flex my-2.5 items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
        동네질문
      </span>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-2">
              The best mandu restaurant is the on next to my house
            </p>
          </div>
        </div>
      </div>
